...
- My capture card isn't showing up!
    - Some capture cards aren't allowed to be open in multiple places. If you have one of these and it's open in OBS or another place, then you won't be able to open it here. To solve this, there are a few options. For all of these, try to ensure your resolution is at least 1280x720.
        ...
        - The second solution is also included as of the second version of our app, using Window Sharing. With this, you can take your OBS canvas, pull out a Full Screen Projector, and then use that as input for our program. We recommend creating the projector from the capture card source, but if you have reason to use your whole canvas, then just be sure not to cover any of the marked areas in the below image. Also keep in mind that displaying a full screen projector through our app may significantly slow down the program.
        ...
        - OBS Virtual Camera may seem appealing but it has not been able to produce a high enough resolution for us so far.
